...
// place a single question can answer both: someone who wants only the
// conversation should not have to find Simple mode afterwards, and someone
// who asked for the terminal deck wants the machinery on.
export const LAYOUTS: Array<{ description: string; id: string; mode: InterfaceMode; name: string; tree: MiniNode }> = [
  ...
  {
    description: 'Terminal, files, and every readout.',
    id: ELITE_LAYOUT_ID,
    mode: 'advanced',
    name: 'Elite',
    tree: {
